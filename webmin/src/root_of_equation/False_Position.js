...
export default class False_Position extends Component{
  ...
  constructor(props)
  {
    ...
    componentDidMount()
      {
        axios.get('http://localhost:8080/False_Position.php')
        .then(res=>{
            ...
            res.data.map(dataMap=>{
              ...
              let optionsObj = {};
              if(dataMap._type === "False_Position")
              {
  ...
  getValue = ()=>{
    ...
    EquationFalsePosition = () =>{
      ...
      formData.append("_type","False_Position");
  ...
  showResult=()=>{
    ...
    {
      return <div>
        <h4>This is Result of False-Position : {this.state.result}</h4><br/>
        ...
        return (
          <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout className="site-layout">
                ...
                <Breadcrumb.Item><Title><Text type="danger">False Position</Text></Title></Breadcrumb.Item>
